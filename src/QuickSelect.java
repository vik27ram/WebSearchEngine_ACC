...
public class QuickSelect {
	...
	public static <AnyType extends Comparable<? super AnyType>> void quickSelect(Integer[] a, int k) {
	...
	public static <AnyType extends Comparable<? super AnyType>> void quickSelect1(Integer[] a, int k) {
		int p = 0;
		@SuppressWarnings("unused")
